...
namespace RiceProduction.Infrastructure.Repository
{
    public interface IAgronomyExpertRepository
    {
        ...
        Task<IEnumerable<AgronomyExpert?>> GetAllAgronomyExpertAssignedOrNotByNameOrEmailAndPhoneNumberPagingAsync(int pageNumber, int pageSize, string? search, string? phoneNumber, bool? freeOrAssigned, CancellationToken cancellationToken = default);
        Task<IEnumerable<AgronomyExpert?>> GetAllAgronomyExpertAsync(CancellationToken cancellationToken = default);
        Task<IEnumerable<AgronomyExpert?>> GetAllAgronomyExpertByNameOrEmailAndPhoneNumberPagingAsync(int pageNumber, int pageSize, string? search, string? phoneNumber, CancellationToken cancellationToken = default);
