            ...
            try
            {
                ...
                var cultivationTasks = await _unitOfWork.Repository<CultivationTask>().ListAsync(
                    filter: ct =>
                        ...
                        (request.IncludePastSeasons == true || ct.PlotCultivation.Season.EndDate >= currentDate.ToString("MM/dd")),
                ...
                var response = cultivationTasks.Select(ct => new FarmerCultivationTaskResponse
                {
                    TaskId = ct.Id,
                    ...
                    Materials = ct.ProductionPlanTask.ProductionPlanTaskMaterials
                        .Select(pptm =>
                        {
                            ...
                            return new TaskMaterialInfo
                            {
                                ...
                                PlannedQuantity = pptm.EstimatedQuantity,
                                PlannedCost = pptm.EstimatedAmount,
                ...
                _logger.LogInformation(
                    "Retrieved {Count} cultivation tasks for farmer {FarmerId}",
                    response.Count,
                    request.FarmerId);
